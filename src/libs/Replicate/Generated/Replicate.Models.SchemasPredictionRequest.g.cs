...
namespace Replicate
{
    ...
    public sealed partial class SchemasPredictionRequest
    {
        ...
        /// </summary>
        /// <example>{"prompt":"Tell me a joke","system_prompt":"You are a helpful assistant"}</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SchemasPredictionRequest" /> class.
        /// </summary>
        /// <param name="input">
        /// The model's input as a JSON object. The input schema depends on what model you are running. To see the available inputs, click the "API" tab on the model you are running or [get the model version](#models.versions.get) and look at its `openapi_schema` property. For example, [stability-ai/sdxl](https://replicate.com/stability-ai/sdxl) takes `prompt` as an input.<br/>
        /// Files should be passed as HTTP URLs or data URLs.<br/>
        ...
        public SchemasPredictionRequest(
            ...
            bool? stream,
            string? webhook,
            global::System.Collections.Generic.IList<global::Replicate.SchemasPredictionRequestWebhookEventsFilterItem>? webhookEventsFilter)
        {
