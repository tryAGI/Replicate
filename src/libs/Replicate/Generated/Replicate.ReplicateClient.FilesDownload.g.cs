...
namespace Replicate
{
    public partial class ReplicateClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> FilesDownloadAsStreamAsync(
            string fileId,
            string owner,
            long expiry,
            string signature,
                ...
                else
                {
                    await global::Replicate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::Replicate.ApiException<global::Replicate.FilesDownloadResponse>.Create(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Replicate.AutoSDKHttpResponse<byte[]>> FilesDownloadAsResponseAsync(
            string fileId,
            string owner,
            long expiry,
            string signature,
                    ...
                    await global::Replicate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Replicate.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
