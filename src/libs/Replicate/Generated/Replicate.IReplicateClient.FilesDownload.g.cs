...
namespace Replicate
{
    public partial interface IReplicateClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::System.IO.Stream> FilesDownloadAsStreamAsync(
            string fileId,
            string owner,
            long expiry,
            string signature,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Replicate.AutoSDKHttpResponse<byte[]>> FilesDownloadAsResponseAsync(
            string fileId,
            string owner,
            long expiry,
            string signature,
