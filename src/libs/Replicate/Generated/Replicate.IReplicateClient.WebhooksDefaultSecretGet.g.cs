...
namespace Replicate
{
    public partial interface IReplicateClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Replicate.AutoSDKHttpResponse<global::Replicate.WebhooksDefaultSecretGetResponse>> WebhooksDefaultSecretGetAsResponseAsync(
            global::Replicate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}