...
namespace Replicate
{
    public partial class ReplicateClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Replicate.SchemasSearchResponse> SearchAsync(
            string query,
            int? limit = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Replicate.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Replicate.AutoSDKHttpResponse<global::Replicate.SchemasSearchResponse>> SearchAsResponseAsync(
            string query,
            int? limit = default,
            global::Replicate.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                else
                {
                    await global::Replicate.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Replicate.ApiException<global::Replicate.SearchResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::Replicate.ApiException<global::Replicate.SearchResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Replicate.AutoSDKHttpResponse<global::Replicate.SchemasSearchResponse>(
                                        statusCode: __response.StatusCode,
